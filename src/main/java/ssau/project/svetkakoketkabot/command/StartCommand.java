...
public class StartCommand {
    ...
    public void commandReceived(Long chatId, String firstName) {
        String message = "Привет, " + firstName + "!\nМеня зовут Светка-Кокетка," +
                " я уже кое-чему научилась!\n" +
                "На данный момент я умею выдавать 5 случайных аниме-тайтлов с помощью команды /anime," +
                "5 случайных фильмов с помощью команды /film," +
                " записывать пользователей в список пожеланий командой /wishes и выдавать жаб после набора необрабатываемых букаф.";
